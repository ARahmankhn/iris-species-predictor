...
def load_model():
    ...
    try:
        ...
        # Catching a general exception for issues during unpickling
        st.error(f"Error loading the model file. It might be corrupted or a library version mismatch has occurred. Please ensure your 'deployment.pkl' file is compatible. Error details: {e}")
        return None
